...
import com.uob.infomate.ChatBot.BotReply;
...
public class SendMessageInBg extends AsyncTask<Void, Void, DetectIntentResponse>
{
    ...
    public SendMessageInBg(BotReply botReply,SessionName session, SessionsClient sessionsClient, QueryInput queryInput)
    {
