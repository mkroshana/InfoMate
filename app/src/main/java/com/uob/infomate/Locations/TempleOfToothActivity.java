...
public class TempleOfToothActivity extends AppCompatActivity {

    private static final String TAG = MainActivity.class.getSimpleName();
    private RatingBar ratingBarTempleOfTooth;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_temple_of_tooth);

        ratingBarTempleOfTooth = findViewById(R.id.RatingTempleOfTooth);
        ...
        ratingSubmit.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                String ratingS = String.valueOf(ratingBarTempleOfTooth.getRating());
                ...
                DatabaseReference myRef = database.getReference("TempleOfTooth");
        ...
        iNavigate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri navUri = Uri.parse("google.navigation:q=Temple of Tooth");
