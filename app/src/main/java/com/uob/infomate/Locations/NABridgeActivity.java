...
public class NABridgeActivity extends AppCompatActivity {

    private static final String TAG = MainActivity.class.getSimpleName();
    private RatingBar ratingBarNABridge;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_nabridge);

        ratingBarNABridge = findViewById(R.id.RatingNABridge);
        ...
        ratingSubmit.setOnClickListener(new View.OnClickListener()
        {
            ...
            {
                String ratingS = String.valueOf(ratingBarNABridge.getRating());
                ...
                DatabaseReference myRef = database.getReference("NABridge");
        ...
        iNavigate.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Uri navUri = Uri.parse("google.navigation:q=Nina Arch Bridge");
